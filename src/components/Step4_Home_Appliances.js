...
const Step4_Home_Appliances = ({step, onStepChange})=> {
      ...
      return (
        <form className="form">
            ...
            <div className="input-container">
                ...
                <p className="line-gap">Please choose Home Appliances Products</p>
            </div>

            <div className="input-container">
                <label className="label_head">Home Appliances Products</label><br />

                <input className="checkbox" type="checkbox"/>
                <label>Utensils & Cookware</label><br />
                <input className="checkbox" type="checkbox"/>
                <label>TV & Other Appliances</label><br />
                <input className="checkbox" type="checkbox"/>
                <label>Other</label>
            </div> 
  ...
  export default Step4_Home_Appliances;
